...
public class SettingsActivity extends PreferenceActivity {
    ...
    private static final ArrayList<MultiDeviceSearchResult> foundDevices = new ArrayList<>();
    ...
    public static class AntFragment extends PreferenceFragment {
        ...
        protected void updateList(final ArrayList<MultiDeviceSearchResult> foundDevices) {
            ArrayList<CharSequence> foundDevicesString = new ArrayList<>();
            ArrayList<CharSequence> foundDevicesValues = new ArrayList<>();
